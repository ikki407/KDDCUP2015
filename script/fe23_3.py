...
dtrain['to+10'] = dtrain['to']+11#＋１増加している
dtest['to+1'] = dtest['to']+1
dtest['to+10'] = dtest['to']+11#＋１増加している

#miss発見
#(ee3['min_time'] < ee2['to+10'])
#としてた
#正解(ee3['min_time'] < ee2['to+1'])
...
df.to_csv('/Users/IkkiTanaka/Documents/KDDCup/fe_train/dffe23_3.csv',index=False)

dtrain['in10days_enr'] = df.iloc[df['enrollment_id'].isin(dtrain['enrollment_id'].values).values,:]['in10days_enr'].values
dtest['in10days_enr'] = df.iloc[df['enrollment_id'].isin(dtest['enrollment_id'].values).values,:]['in10days_enr'].values
...
dtrain_leaf2.to_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_trainfe23_3.csv',index=False)
dtest_leaf2.to_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_testfe23_3.csv',index=False)
label.to_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_labelfe23_3.csv',index=False)
...
#0.9055267800273838
pred_all42_0.903895_1568_7.csv
