...
#del dtrain['(to-from)-len_time'], dtest['(to-from)-len_time']
...
pred3 = pd.read_csv('/Users/IkkiTanaka/Documents/KDDCup/pred/xgb/pred_all422_0.899011_1229_8.csv',header=None)


final_pred = (pred1[1]+pred2[1]+pred3[1])/3.0
final_pred = pd.concat([pred1[0],final_pred],axis=1)
final_pred.to_csv('/Users/IkkiTanaka/Documents/KDDCup/pred/xgb/PRED_ALL10.csv',header=None,index=False)
