...
df.to_csv('/Users/IkkiTanaka/Documents/KDDCup/fe_train/df2.csv',index=False)
...
'''
df = pd.read_csv('/Users/IkkiTanaka/Documents/KDDCup/fe_train/df2.csv')
dtrain['in10days_enr'] = df.iloc[df['enrollment_id'].isin(dtrain['enrollment_id'].values).values,:]['in10days_enr'].values
dtest['in10days_enr'] = df.iloc[df['enrollment_id'].isin(dtest['enrollment_id'].values).values,:]['in10days_enr'].values
...
#dtrain_leaf2.to_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_trainfe23_2.csv',index=False)
#dtest_leaf2.to_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_testfe23_2.csv',index=False)
#label.to_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_labelfe23_2.csv',index=False)
...
#0.9055565322138303
pred_all42_0.904065_1483_7.csv
