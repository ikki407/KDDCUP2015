...
for i in xrange(2,num_model,20):
    ...
    if cc > 0.8980:
        ...
        pred_name.append('/Users/IkkiTanaka/Documents/KDDCup/pred/xgb/pred_allfe24_2%i_%f_%i_%i.csv' % (i,cc,num_round_, param["bst:max_depth"]))
        preds.to_csv('/Users/IkkiTanaka/Documents/KDDCup/pred/xgb/pred_allfe24_2%i_%f_%i_%i.csv' % (i,cc,num_round_, param["bst:max_depth"]) ,header=None,index=False)
...
fe24
'''
dtrain_leaf2 = pd.read_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_trainfe24.csv')
dtest_leaf2 = pd.read_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_testfe24.csv')
label = pd.read_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_labelfe24.csv',header=None)
label = label[0]
...
for i in xrange(2,num_model,20):
    ...
    if cc > 0.8980:
        ...
        sample = pd.read_csv('/Users/IkkiTanaka/Documents/KDDCup/sampleSubmission.csv',header=None)
        preds = pd.concat([sample[0],pd.DataFrame(pred_prob)],axis=1)
        pred_name.append('/Users/IkkiTanaka/Documents/KDDCup/pred/xgb/pred_all_fe24%i_%f_%i_%i.csv' % (i,cc,num_round_, param["bst:max_depth"]))
        preds.to_csv('/Users/IkkiTanaka/Documents/KDDCup/pred/xgb/pred_allfe24%i_%f_%i_%i.csv' % (i,cc,num_round_, param["bst:max_depth"]) ,header=None,index=False)
