...
dtrain_leaf2.to_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_train_final1.csv',index=False)
dtest_leaf2.to_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_test_final1.csv',index=False)
label.to_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_label_final1.csv',index=False)
...
del train['time_ordinal'],test['time_ordinal']
...
dtrain_leaf2.to_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_train_final2.csv',index=False)
dtest_leaf2.to_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_test_final2.csv',index=False)
label.to_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_label_final2.csv',index=False)
...
読み込み
'''
dtrain1 = pd.read_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_train_final1.csv')
dtrain2 = pd.read_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_train_final2.csv')
dtrain = pd.concat([dtrain1,dtrain2],axis=1)
del dtrain1,dtrain2


dtest1 = pd.read_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_test_final1.csv')
dtest2 = pd.read_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_test_final2.csv')
dtest = pd.concat([dtest1,dtest2],axis=1)
del dtest1,dtest2

label = pd.read_csv('/Users/IkkiTanaka/Documents/ikeda/ikeda_label_final1.csv',header=None)
label = label[0]
...
for i in xrange(2,num_model,20):
    ...
    num_round = int( round(random.uniform(1350, 1400),0))
